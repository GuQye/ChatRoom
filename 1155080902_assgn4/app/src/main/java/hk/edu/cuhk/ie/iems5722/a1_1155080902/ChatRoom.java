...
public class ChatRoom extends AppCompatActivity {
                ...
                if (firstVisibleItem == 0) {
                    ...
                    if (firstItem != null && firstItem.getTop() == 0) {
                        ...
                        if (temp <= Integer.parseInt(total_pages)) {
                            String path = String.format("http://54.169.85.220/api/asgn3/get_messages?chatroom_id=%s&page=%d", chatroom_id, ++page);
    ...
    public void init_chatroom() {
        page = 1;
        String path = String.format("http://54.169.112.52/api/asgn3/get_messages?chatroom_id=%s&page=%d", chatroom_id,page);
        new BackgroundTask().execute(path);
    }
            ...
            if (!"".equals(params[0])) {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("http://54.169.112.52/api/asgn3/send_message")
                            .post(requestBody)
                            .build();
                    ...
                    if (!json.isNull("data")) {
                        ...
                        for (int i = 0; i < chat_list.length(); i++) {
                            ...
                            if (i + 1 <= chat_list.length()) {
                                ...
                                next_year = next_timestamp.split("-")[0];
                                next_month = next_timestamp.split("-")[1];
                            ...
                            if (!next_day.equals(day) && !"".equals(next_day)) {
